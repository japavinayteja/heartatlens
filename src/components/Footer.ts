  ...
  render(): string {
    return `
      <footer class="main-footer">
        <!-- First Row: Navigation and Social Media -->
        <div class="footer-content" style="padding: 1rem 0;">
          <div class="footer-container">
            <div class="footer-nav flex-1 justify-center">
              <a href="#" class="footer-link" data-page="faqs">FAQs</a>
              <a href="#" class="footer-link" data-page="privacy">Privacy Policy</a>
              <a href="#" class="footer-link" data-page="terms">Terms of Use</a>
        ...
        <div class="footer-copyright" style="padding: 1rem 0;">
          <div class="footer-container">
            <p>© 2025 HeartAtLens Photography. All rights reserved.</p>
          </div>
        </div>
      </footer>
    `;
